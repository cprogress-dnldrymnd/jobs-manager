...
if (!class_exists('JobsManager')) {
    class JobsManager
    {
        ...
        function assets()
        {
            ...
            wp_enqueue_style('jobsmanager-style', WP_PLUGIN_DIR . '/jobs-manager/assets/css/jobsmanager.css');
            wp_enqueue_script('jobsmanager-style', WP_PLUGIN_DIR . '/jobs-manager/assets/js/jobsmanager.js');
