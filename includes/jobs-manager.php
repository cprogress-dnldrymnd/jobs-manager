...
if (!class_exists('JobsManager')) {
    class JobsManager
    {
        ...
        function assets()
        {
            ...
            wp_enqueue_style('jobsmanager-style', plugin_dir_url(plugin_basename(__FILE__)) . '/assets/css/jobsmanager.css');
            wp_enqueue_script('jobsmanager-style', plugin_dir_url(plugin_basename(__FILE__)) . '/assets/js/jobsmanager.js');
