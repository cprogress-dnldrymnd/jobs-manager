...
if (!class_exists('JobsManager')) {
    class JobsManager
    {
        ...
        function assets()
        {
            ...
            wp_enqueue_style('jobsmanager-style', plugin_dir_url('') . '/assets/css/jobsmanager.css');
            wp_enqueue_script('jobsmanager-style', plugin_dir_url('') . '/assets/js/jobsmanager.js');
